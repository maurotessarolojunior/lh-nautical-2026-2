...
Os três caminhos partem da mesma origem (`data/raw/1-lh_nautical_csv/`) e reutilizam as mesmas regras de negócio já validadas, mas não dependem fisicamente um do outro — nenhum lê a saída do outro. O dashboard está concluído: os seis extratos foram gerados e validados por `Submissão/Dashboard/gerar_dados.py`, o painel foi construído no Looker Studio a partir deles, e o PDF final está em [`Submissão/Dashboard/LH_Nautical_2026_2_Dashboard.pdf`](Submissão/Dashboard/LH_Nautical_2026_2_Dashboard.pdf).
...
│   ├── Apresentação/                # PDF da apresentação de 10 slides
...
Painel construído no Looker Studio a partir dos seis extratos de `data/processed/marts/dashboard/` (gerados e validados por `Submissão/Dashboard/gerar_dados.py` — dicionário completo em `Submissão/Dashboard/README.md`). PDF final: [`Submissão/Dashboard/LH_Nautical_2026_2_Dashboard.pdf`](Submissão/Dashboard/LH_Nautical_2026_2_Dashboard.pdf).
